...
void video_renderer_update(vidc_bitmap_t *src, int x1, int y1, int x2, int y2, int dest_x, int dest_y);
void video_renderer_update_overlay(uint8_t *src, int x1, int y1, int x2, int y2, int dest_x, int dest_y);
void video_renderer_present(int src_x, int src_y, int src_w, int src_h, int dblscan);
void video_renderer_flip();
int video_renderer_refresh_rate_hz();
